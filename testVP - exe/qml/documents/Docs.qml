...
Item {
    ...
    NavigateLeftButton {
        ...
        visible: docsPagesListView.currentIndex > 0

        onClicked: docsPagesListView.decrementCurrentIndex()
    }
    ...
    NavigateRightButton {
        ...
        visible: docsPagesListView.currentIndex < (docsPagesListView.count - 1)

        onClicked: docsPagesListView.incrementCurrentIndex()
    }
