...
Item {
    ...
    VideoarchiveBackgroundPhotosModel {
        id: underdecorModel
    }
    ...
    Image {
        source: "../../resources/videoarchive/main-screen/fire-bg.png"
    }

    ListView {
        id: videoPagesListView
        anchors.fill: parent
                ...
                delegate: Item {
                    ...
                    PushButtonMouseArea {
                        ...
                        */
                        ...
                        onClicked: {
                            buttonSound.play()
                            screensView.showScreen("videoarchive-player", movie)
                        }
                    }
                }
            }
    ...
    NavigateLeftButton {
        ...
        visible: videoPagesListView.currentIndex > 0

        onClicked: videoPagesListView.decrementCurrentIndex()
    }
    ...
    NavigateRightButton {
        ...
        visible: videoPagesListView.currentIndex < (videoPagesListView.count - 1)

        onClicked: videoPagesListView.incrementCurrentIndex()
    }
